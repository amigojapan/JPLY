<?php
  ...
  $db = new SQLite3($dir . 'visitor-counter.sqlite3');
...
<body>
  ...
  <?php 
    ...
    ?>    
        <div style="display: inline;">Visitor count:</div><div style="border: 2px solid black; width: 100px; display: inline;"> <?php echo $visitors; ?></div><div style="display: inline;">.</div>
        <div style="display: inline;">This page has been clicked</div><div style="border: 2px solid black; width: 100px; display: inline;"> <?php echo $totalvisit; ?> </div><div style="display: inline;"> times.</div>
    <?php
    } 
    ...
    if($pagename == "https://amjp.psy-k.org/JPLY/visitor-counter/test.php") {
    ?>    
        <div style="display: inline;">Visitor count:</div><div style="border: 2px solid black; width: 100px; display: inline;"> <?php echo $visitors; ?></div><div style="display: inline;">.</div>
        <div style="display: inline;">This page has been clicked</div><div style="border: 2px solid black; width: 100px; display: inline;"> <?php echo $totalvisit; ?> </div><div style="display: inline;"> times.</div>
    <?php
